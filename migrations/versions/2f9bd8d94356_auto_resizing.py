...
Revision ID: 2f9bd8d94356
Revises: 
Create Date: 2019-08-31 10:40:40.517376
...
def upgrade():
    ...
    sa.Column('small_path', sa.String(length=140), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['pinned_post_id'], ['post.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('avatar_path', sa.String(length=140), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
