...
Revision ID: fb0c797288fd
Revises: 
Create Date: 2019-04-08 15:56:24.839760
...
def upgrade():
    ...
    sa.Column('emoji_name', sa.String(length=140), nullable=True),
    sa.Column('icon_path', sa.String(length=140), nullable=True),
